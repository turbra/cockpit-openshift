...
Version:        0.1.0
Release:        1%{?dist}
Summary:        Cockpit plugin for local OpenShift and MicroShift installation
...
%description
Cockpit OpenShift is a Cockpit plugin prototype for guided
OpenShift and MicroShift installation workflows.

The current release provides:
- a wizard-style installer UI
- a separate MicroShift host install workflow
...
install -m 0644 src/cockpit-openshift/microshift.html %{buildroot}%{_datadir}/cockpit/cockpit-openshift/
...
install -m 0644 src/cockpit-openshift/microshift.js %{buildroot}%{_datadir}/cockpit/cockpit-openshift/
...
install -m 0755 src/cockpit-openshift/microshift_backend.py %{buildroot}%{_datadir}/cockpit/cockpit-openshift/
